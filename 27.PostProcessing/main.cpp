...
written in HLSL and GLSL, and hence could not be applied to D3D8.
...
int main()
{
    ...
    Direct3D and OpenGL drivers. Note that Direct3D 8 is not capable with
    high level shaders. It is simply ignored in this example.
    ...
    */
    ...
    {
        device->getLogger()->log("WARNING: Post processing disabled"\
            "for Direct3D 8 driver.");
    }

    switch(driverType)
    {
    case video::EDT_DIRECT3D9:
        psFileName = "../../media/pp_d3d9.hlsl";
        vsFileName = psFileName; // both shaders are in the same file
        break;

    case video::EDT_OPENGL:
        psFileName = "../../media/pp_opengl.frag";
        vsFileName = "../../media/pp_opengl.vert";
        break;
    }
